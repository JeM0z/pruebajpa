...
public class FrmManteProd extends JFrame {
	...
	void listado() {
		...
		List<Producto> lstProductos = em.createQuery("select po from Producto po").getResultList();
		txtSalida.setText("");
		for (Producto po : lstProductos) {
			txtSalida.append(po.getId_prod() + "" + po.getEst_prod() + "" + po.getStk_prod() +
			po.getPre_prod() + "\n");
		}
